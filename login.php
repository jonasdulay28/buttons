...
$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sess = $_SESSION['userSession'];
     try{
    $isAdmin = $conn->query("SELECT * FROM tbl_users WHERE userID = $sess");
    $AdminOrNot = $isAdmin->fetch();
  }
   catch(PDOException $e)
        {
            echo $e->getMessage();
        }
    if($AdminOrNot['isAdmin']=='Y'){
  ...
  <div class="form">
		...
		if(isset($_GET['inactive']))
		{
            ...
            <div class='alert alert-error'>
				 This Account is not Verified Go to your Email Inbox and Verify it. 
			</div>
            <?php
		}
		?>
