...
{
    //echo "<script>alert('".$isUserAdmin."');</script>";
  //  
}
else
{
...
$create_sql = $user_home->runQuery("INSERT INTO btns_Pages(Title, Content) VALUES(:title,:content)");
if($create_sql->execute(array(':title' => $_POST['title'],':content' => $_POST['content'] ))){
    $create_true = true;
}else{
    $create_true = false;
}
        ...
        <div class="page-container">
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">Howdy,&nbsp;<?php echo $row['first_name']; ?></div>
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Add Page</h2>
                </div>
                <!-- END PAGE TITLE -->                
                <div ng-app="">
...
Title<br/><input  class="form-control"  style="width:400px;" type="text" name='title'/><br/>
                            <div class="block">
                                <h4>Summernote</h4>

                                    
                                <textarea class="summernote" name='content' ng-model="code">
                                    </textarea>
                                    <br/>
                                    <br/>
                                    <br/>
                                    <button class="btn btn-danger" type="submit" name="btn-create">CREATE</button>
                                    </form>
                                    <?php if($create_true===false){
                                        echo "error";
                                        }elseif($create_true===true){
                                            echo "<br/>";
                                            echo "<br/>";
                                            echo "<center>";
                                        echo "<span style='hieght:10px;background-color:black;color:white;'>Page successfully created!</span>";
                                        echo "</center>";
                                        } ?>
                            </div>
