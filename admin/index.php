...
<html lang="en">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon" onclick="location.href='inbox.php';">
                                <div class="widget-item-left">
                                    <span class="fa fa-envelope"></span>
                                </div>
                                <?php $totalmsg = $user_home->new_message_count(); ?>                             
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php echo $totalmsg; ?></div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon">
                                ...
                                <?php 
                                $usercount = $user_home->reg_user_count();
                                 ?>
                                <div class="widget-data">
    ...
    <!-- START SCRIPTS -->
        ...
        <?php
        require_once'../../class.user.php';
        $stmt_jvm = $user_home->runQuery("SELECT * FROM tbl_hits_info WHERE date(time_accessed) = date(CURDATE())");
